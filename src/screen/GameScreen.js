...
<Text style={{ fontSize: 20, fontWeight: 'bold' }}>STEP : {state.count}</Text>
</View>
</View>

<ScrollView style={styles.cardListContainer} contentContainerStyle={{justifyContent: 'space-around', flexDirection: 'row', flexWrap: 'wrap'}}>
